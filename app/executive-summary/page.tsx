...
export default function ExecutiveSummaryPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 space-y-5 text-gray-800 text-sm leading-relaxed">
        ...
        <h2 className="text-lg font-bold text-brand-800 pt-4">
          Integrated Synthesis: A Rights-Based Architecture for Trustworthy Organ Donation
        </h2>

        <h3 className="font-semibold text-gray-900">1. Trust as the Organizing Principle</h3>
        <p>
        ...
        <h3 className="font-semibold text-gray-900">2. Primacy of End-of-Life Care and Moral Pluralism</h3>
        <p>Articles 1&ndash;4 establish the ethical boundary conditions of legitimate organ donation:</p>
        ...
        <h3 className="font-semibold text-gray-900">3. Protection of Autonomy Under Conditions of Vulnerability</h3>
        <p>
        ...
        <h3 className="font-semibold text-gray-900">6. Public Discourse, Participation, and Adaptive Ethics</h3>
        <p>
